...
namespace Einsendeaufgabe3._1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Geben Sie bitte gewünschte Jahreszahl: ");
            jahresZahl = Convert.ToInt32(Console.ReadLine());

            if ((jahresZahl % 4 == 0) && (jahresZahl % 100 != 0))
            {
                Console.WriteLine("Herzlichen glückwunsch das ist ein Schaltjahr.");
            ...
            {
                Console.WriteLine("Leider das ist kein Schaltjahr.");
            }
            Console.ReadLine();
        }
    }
